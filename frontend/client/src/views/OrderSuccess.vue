      ...
      <el-card class="success-card">
        ...
        <div class="delivery-info">
          ...
          <el-timeline>
            ...
            <el-timeline-item timestamp="预计4-6小时" type="info" size="large">
              <h4>准备配送</h4>
        ...
        <div class="tips-section">
          ...
          <el-alert title="重要提醒" type="info" :closable="false" show-icon>
            <ul class="tips-list">
        ...
        <div class="action-buttons">
          <el-button size="large" @click="goHome" style="width: 200px">
            返回首页
          </el-button>
...
const viewOrder = () => {
  if (orderInfo.value) {
    ElMessage.info(
      `订单号：${orderInfo.value.order_no}，您可以保存此订单号以便后续查询`
    );
  }
};
