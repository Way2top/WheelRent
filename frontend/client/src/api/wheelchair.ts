...
export const wheelchairApi = {
  // 搜索轮椅
  search: (params: WheelchairSearchParams): Promise<ApiResponse<WheelchairSearchResponse>> => {
...
export const orderApi = {
  // 创建预订单
  createTempOrder: (data: CreateTempOrderParams): Promise<ApiResponse<CreateTempOrderResponse>> => {
    return api.post('/order/precreate', data)
  },

  // 提交正式订单
  submitOrder: (data: SubmitOrderParams): Promise<ApiResponse<SubmitOrderResponse>> => {
